...
# Build library
g++ -fPIC -std=c++17 -fopenmp -g -c bfv.cpp -o libbfv.o -I/usr/local/include/SEAL-4.1 -lseal-4.1 -ltbb -fconstexpr-depth=25000
g++ -fPIC -std=c++17 -g -c util.cpp -o libutil.o -I/usr/local/include/SEAL-4.1 -lseal-4.1
g++ -shared -g libbfv.o libutil.o libbfv.h -o libbfv.so -I/usr/local/include/SEAL-4.1 -lseal-4.1
